...
import { sendPasswordRecoveryEmail } from "@/lib/notifications/email";
...
export async function POST(req: NextRequest) {
    try {
        ...
        const { data, error } = await supabaseAdmin.auth.admin.generateLink({
            ...
            email,
            options: {
                redirectTo: `${process.env.NEXT_PUBLIC_APP_URL || 'https://mediclock.click'}/auth/callback?next=/auth/update-password`,
            }
        });
